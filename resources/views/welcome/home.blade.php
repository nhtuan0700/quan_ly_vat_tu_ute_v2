...
@section('body')
  <div class="body-content">
    <div class="w-75 m-auto">
      <h5 class="text-center">Hệ thống cung cấp giải pháp tự động hóa các quy trình mua sắm, sửa chữa thiết bị tại
        trường đại học Sư Phạm Kỹ Thuật - Đại Học Đà Nẵng</h5>
    </div>
  </div>
