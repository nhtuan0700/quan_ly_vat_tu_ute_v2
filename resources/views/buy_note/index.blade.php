        ...
        <div class="card">
          <div class="card-header">
            <div class="d-flex  align-items-center">
              ...
              <a href="{{ route('buy_note.list_period') }}" class="btn btn-success">Tạo mới</a>
            </div>
          </div>

          <div class="card-body pb-0">
            {{-- Search --}}
            <form method="GET" action="{{ route('buy_note.search') }}">
              <div class="form-row">
                <div class="form-group col-md-2">
                  <label for="id">Mã phiếu:</label>
                  <input type="text" class="form-control" id="id" name="id"1
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex justify-content-center">
                      <a href="{{ route('buy_note.detail', ['id' => $item->id]) }}"
