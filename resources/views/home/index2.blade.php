        ...
        <div class="card-body">
          <div>
            <div id="carousel" class="carousel slide carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  ...
                  <div class="description">
                    ...
                    <p class="content">Ứng dụng công nghệ thông tin giúp giải quyết các yêu cầu dễ dàng nhanh chóng
                      hơn</p>
                  </div>
                </div>
              ...
              <button class="carousel-control-prev carousel-button" type="button" data-target="#carousel"
                data-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
              </button>
              <button class="carousel-control-next carousel-button" type="button" data-target="#carousel"
                data-slide="next">
